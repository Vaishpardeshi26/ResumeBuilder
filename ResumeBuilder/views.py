...
import pyrebase 
# 'apiKey': "AIzaSyBUlS4v-aM9APm66FhQM0W9XEguiCDSNaQ",
#     'authDomain': "resumebuilder-dec1e.firebaseapp.com",
#     'databaseURL': "https://resumebuilder-dec1e-default-rtdb.firebaseio.com/",
#     'projectId': "resumebuilder-dec1e",
#     'storageBucket': "resumebuilder-dec1e.appspot.com",
#     'messagingSenderId': "912295915721",
#     'appId': "1:912295915721:web:6a7dcec24d47cc4bf1dd18",
#     'measurementId': "G-WP3N87RH54"
config = {
...
#   projectId: "resumebuilder-e2b17",
#   storageBucket: "resumebuilder-e2b17.appspot.com",
#   messagingSenderId: "478792749082",
#   appId: "1:478792749082:web:fe0915f2bce4d6d55281a3",
#   measurementId: "G-RQ72XTDY9W"
...
def login(request):
    ...
    try:
        if request.method == "POST":
            ...
            try:
                auth.sign_in_with_email_and_password(s1, s2)
...
def logout1(request):
    ...
    # Add this to that button onclick="location.href{% url 'url_name' %}"
...
def page2(request):
    ...
    try:
        if request.method == "POST":
            ...
            data = {
                'college' : e1,
                'qualification_College' : e2,
                'description_College' : e3,
                'school' : e4,
                'qualification_School' : e5,
                'description_School' : e6,
                'date1': e7,
                'date2': e8,
                'date3': e9,
                'date4': e10,
...
def page4(request):
    ...
    try:
        if request.method == "POST":
            ...
            data = {
                'Exp1_institution' : Ex1,
                'Exp1_StartDate' : Ex2,
                'Exp1_EndDate' : Ex3,
                'Exp1_desc' : Ex4,
                'Exp2_institution' : Ex5,
                'Exp2_StartDate' : Ex6,
                'Exp2_EndDate' : Ex7,
                'Exp2_desc' : Ex8,
                'Exp1_position': Ex9,
